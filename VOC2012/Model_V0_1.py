...
def DownSampling_block(x, input_depth, channel, Momentum=0.1):
    ...
    y = Activation("relu")(y)
    y = ZeroPadding2D(padding=((1, 1), (1, 1)))(y)
    y = DepthwiseConv2D((3, 3), strides=(2, 2))(y)
    y = BatchNormalization(momentum=Momentum)(y)
    y = Activation("relu")(y)
    return y
...
def UpSampling_block(x, input_depth, channel, Momentum=0.1):
    ...
    y = BatchNormalization(momentum=Momentum)(y)
    y = Activation("relu")(y)
    y = Conv2DTranspose(channel, (2, 2), strides=(2, 2))(y)
    y = BatchNormalization(momentum=Momentum)(y)
    y = Activation("relu")(y)
...
def TestNet(input_shape=(32, 32, 3), classes=5):
    ...
    x = Concatenate(axis=3)([x, input_1])
    ...
    x = Concatenate(axis=3)([x, input_2])
